...
$(document).ready(function ()
{
    ...
    chrome.storage.local.get(["key", "address", "password", "encrypted", "gpgPublic", "gpgPrivate", "gpgKeys", "msgCount", "gpgMessages", "gpgPassword", "msgBuffer", "price", "lastTab", "currency", "newsType"], function (data)
    {
